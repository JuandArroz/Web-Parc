        ...
        switch(sesionusuario.tipouser){
            ...
            case 1:
                opc4.innerHTML += `
                    ...
                    <li class="nav-item">
                        <span class="nav-link text-warning"><i class="fa-solid fa-user-tie"></i>${sesionusuario.nombres} ${sesionusuario.apellidos}</span>
                    </li>
                    <li class="nav-item">
                    <button class="btn btn-warning" id="delog" onclick="limpiar_sesion()">Cerrar sesion</button>
                    </li>                       
            ...
            case 2:
                opc4.innerHTML += `
                    <li class="nav-item">
                        <span class="nav-link text-light"><i class="fa-solid fa-user-graduate"></i>${sesionusuario.nombres} ${sesionusuario.apellidos}</span>
                    </li>                    
                    <li class="nav-item">
                        <button class="btn btn-warning" id="delog" onclick="limpiar_sesion()">Cerrar sesion</button>
                    </li>      
