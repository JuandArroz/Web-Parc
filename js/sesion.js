        ...
        switch(sesionusuario.tipouser){
            case 0:
                opc4.innerHTML += `
                    ...
                    <li class="nav-item">
                        <span class="nav-link text-warning"><i class="fa-solid fa-user-secret fa-xl"></i> ${sesionusuario.nombres}</span>
                    </li>
                    <li class="nav-item">
            ...
            case 1:
                opc4.innerHTML += `
                    ...
                    <li class="nav-item">
                        <span class="nav-link text-warning"><i class="fa-solid fa-user-tie"></i> ${sesionusuario.nombres}</span>
                    </li>
                    <li class="nav-item">
                    <button class="btn btn-warning" id="delog" onclick="limpiar_sesion()">Cerrar sesion</button>
                    </li>                       
