    ...
    if(sesionusuario){
        switch(sesionusuario[0].tipouser){
            case 0:
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <h6 class="dropdown-header">Opciones de administrador <i class="fa-solid fa-user-secret"></i></i></h6>
                            <a class="dropdown-item text-warning" href="tabladedatos.html">Listado de estudiantes</a>
                        </li>
                        <li>
                            <a class="dropdown-item text-warning" href="dashboard.html">Dashboard</a>
                        </li>
                        <li>
                            <a class="dropdown-item text-warning" href="agregarusuario.html">Agregar usuario</a>
                        </li>
                        <li>
                            <a class="dropdown-item text-warning" href="subirtesis.html">Subir tesis</a>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
                            <h6 class="dropdown-header">Opciones de docente <i class="fa-solid fa-user-tie"></i></h6>
                        ...
                        <li>
                            <a class="dropdown-item text-warning" href="propuestasadmin.html">Propuestas</a>
                        </li>
                    </ul>
                </li>
                `
            ...
            case 1:
                opc4.innerHTML += `
                    <li class="nav-item">
                        <a class="nav-link text-warning" href="propuestas_revi.html">Propuestas</a>
                    </li>                     
                `
                opc5.innerHTML += `
                    <li class="nav-item">
            ...
            case 2:
                opc4.innerHTML += `
                    <li class="nav-item">
                        <a class="nav-link text-light" href="enviar_propuesta.html">Enviar propuesta</a>
                    </li>
                `
                opc5.innerHTML += `
                    <li class="nav-item">
